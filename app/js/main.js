(function() {
    angular.module('inquisi', ['ui.router', 'ngResource', 'ngSanitize', 'ngCookies', 'hmTouchEvents', 'ui.bootstrap', 'angularCharts', 'angular.screenmatch', 'angular-sortable-view', 'angular-md5', // vendor dependencies
